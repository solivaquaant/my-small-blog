...
A challenge with a very similar solution can be found at [JaWT Scratchpadb - Cylab](https://blog.solivaquaant.site/docs/cylab/web-exploitation/jawt-scratchpad/).
