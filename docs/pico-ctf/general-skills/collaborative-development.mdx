...
To list all available branches in the repository, we use the `git branch` command. In this project, in addition to the main branch (`main`), there are three feature branches: `feature/part-1`, `feature/part-2`, and `feature/part-3`.
```bash
