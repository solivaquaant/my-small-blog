...
return-object v5
```
Recompile the APK, generate a keystore and sign the APK, and reinstall the modified app (you can see details how to do this in the [previous droids](https://blog.solivaquaant.site/docs/cylab/reverse-engineering/droids3/) writeup).
