...
Actually, Maria's password was discovered in a previous challenge, specifically [**Mission 0x40**](https://blog.solivaquaant.site/docs/hack-my-vm/hvmlabs/chapter-1/mission-0x40). 
